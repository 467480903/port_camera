...
def main():
    source_dir = '/home/yy/port_camera/label/0130'
    train_labels_dir = '../yoloTrain5/train/labels/'
    train_images_dir = '../yoloTrain5/train/images/'
    val_labels_dir = '../yoloTrain5/val/labels/'
    val_images_dir = '../yoloTrain5/val/images/'
